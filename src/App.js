...
function Visual() {
	...
	const [quote, setQuote] = useState("If you don't believe it or don't get it, I don't have the time to try to convince you, sorry.");
	const [author, setAuthor] = useState("Satoshi Nakamoto");
		...
		<>
			<div className="grid place-items-center h-screen">
				<div className="relative box content h-2/6 w-4/6 p-4 border-4 content-start rounded-xl">
					...
					<img src={"./black-quote.png"} className="h-2 w-2 object-cover lg:h-12 lg:w-12 md:h-8 md:w-8 sm:h-4 sm:w-4" />
			...
			<div className="absolute h-10 w-10 left-6 bottom-6 transition-colors duration-500 ease-in-out transform 
							hover:scale-110 cursor-pointer">
